...
const getRunes = function() {
    ...
    document.getElementById('alchemiser').innerHTML = Math.floor(alchemiserprice).toLocaleString();
    document.getElementById('alchemisermkii').innerHTML = Math.floor(alchemisermkiiprice).toLocaleString();
