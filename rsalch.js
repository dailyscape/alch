...
const getRunes = function() {
    ...
    // document.getElementById('firerune').setAttribute('title', 'Change: ' + (rsapidata[fireruneid].price > rsapidata[fireruneid].last ? '+' : '') + (rsapidata[fireruneid].last != rsapidata[fireruneid].price ? (rsapidata[fireruneid].price - rsapidata[fireruneid].last).toLocaleString() : ''));
    ...
    // document.getElementById('naturerune').setAttribute('title', 'Change: ' + (rsapidata[natureruneid].price > rsapidata[natureruneid].last ? '+' : '') + (rsapidata[natureruneid].last != rsapidata[natureruneid].price ? (rsapidata[natureruneid].price - rsapidata[natureruneid].last).toLocaleString() : ''));
    ...
    // document.getElementById('divinecharge').setAttribute('title', 'Change: ' + (rsapidata[divinechargeid].price > rsapidata[divinechargeid].last ? '+' : '') + (rsapidata[divinechargeid].last != rsapidata[divinechargeid].price ? (rsapidata[divinechargeid].price - rsapidata[divinechargeid].last).toLocaleString() : '') + ' per 3000 charges');
    ...
    for (let itemid in rsapidata) {
        if ("highalch" in rsapidata[itemid] && !skipids.includes(itemid)) {
            ...
            newRow.children[2].innerHTML = '<span>' + rsapidata[itemid].price.toLocaleString() + '<span class="coin">●</span></span>';
